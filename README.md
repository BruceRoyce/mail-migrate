...
3. Click **Discover folders & build plan**. Review mappings, counts, estimated bytes, size blockers and existing destination content. Folder exclusions/overrides are under Folder policy. A detected label/aggregate view needs an explicit strategy.
